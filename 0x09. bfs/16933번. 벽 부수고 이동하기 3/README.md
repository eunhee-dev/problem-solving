...
2. 가장 직관적인 풀이는 이전 [2206번. 벽 부수고 이동하기](../2206번.%20벽%20부수고%20이동하기/) 문제에서 `broken_cnt`에 대해 차원을 추가하여 상태를 관리한 것 처럼, day/night 여부에 대해서도 차원을 추가하여 4차원 배열로 해결하는 것임. ([solve_4d_fail.py](./solve_4d_fail.py))
...
4. [14442번. 벽 부수고 이동하기 2](../14442번.%20벽%20부수고%20이동하기%202/)의 [solve_2d.py](../14442번.%20벽%20부수고%20이동하기%202/solve_2d.py) 풀이를 활용하여 2차원 배열로 풀 수 있다. ([solve.py](./solve.py))
